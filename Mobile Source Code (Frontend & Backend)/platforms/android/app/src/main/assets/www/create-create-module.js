...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-back-button></ion-back-button>\n    </ion-buttons>\n    <ion-title>Add Feeding Schedule</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-item>\n    <ion-label color=\"primary\" position=\"floating\">Nama</ion-label>\n    <ion-input [(ngModel)]=\"dataJadwal.nama\" type=\"text\" placeholder=\"Nama Jadwal\"></ion-input>\n  </ion-item>\n  <form [formGroup]=\"jadwalForm\">\n    <ion-input hidden [(ngModel)]=\"dataJadwal.nama\" type=\"text\" placeholder=\"Nama Jadwal\" formControlName=\"nama\">\n    </ion-input>\n    <ion-item>\n      <ion-label>Jadwal</ion-label>\n      <ion-datetime display-format=\"HH:mm\" picker-format=\"HH:mm\" formControlName=\"jadwal_jam\"\n        [(ngModel)]=\"dataJadwal.jadwal_jam\"></ion-datetime>\n    </ion-item>\n    <ion-button shape=\"round\" color=\"primary\" expand=\"block\" [disabled]=\"!jadwalForm.valid\" (click)=\"savejadwal()\">Save\n    </ion-button>\n  </form>\n</ion-content>"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NyZWF0ZS9jcmVhdGUucGFnZS5zY3NzIn0= */"
...
/*!***************************************!*\
  !*** ./src/app/create/create.page.ts ***!
  \***************************************/
/*! exports provided: CreatePage, snapshotToObject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CreatePage = /** @class */ (function () {
    function CreatePage(route, router, formBuilder) {
        this.route = route;
        this.router = router;
        this.formBuilder = formBuilder;
        this.ref = Firebase__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('jadwals/');
        ...
        this.jadwalForm = this.formBuilder.group({
            'nama': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            'jadwal_jam': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
        });
        this.dataJadwal.nama = this.jadwalForm.value.nama;
        this.dataJadwal.jadwal_jam = moment__WEBPACK_IMPORTED_MODULE_5__(this.jadwalForm.value.jadwal_jam).format("HH:MM");
    }
    CreatePage.prototype.ngOnInit = function () {
    };
    CreatePage.prototype.savejadwal = function () {
        Firebase__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('jadwals/' + this.dataJadwal.nama + '/').set(this.dataJadwal);
